...
$this->link["Open Map Editor"] = "";
$this->link["View Map"] = "viewmap.php";

$this->title['edit'] = "Map Editor";
/*
$this->text['edit']  = "To add a dot to the editor, use the <a href=\"../entries/\">";
$this->text['edit'] .= "Entry Editor</a> to set an Entry's \"Show on Map\" value to ";
